...
1. In **Microsoft Copilot**, in the navigation pane, select the **Researcher** agent under the **Agents** section. If the **Researcher** agent doesn't appear, select **More agents**, and then in the **Agent Store** window, select **Researcher** under the **Built by Microsoft** section.
